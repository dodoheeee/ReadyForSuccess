...
2. 개인당 5분은 커리큘럼 질문에 대한 대답, 나머지 5분은 꼬리 질문
3. 서로 좋은 피드백을 해주는 시간 가져보기 (자세,지식)
4. 공부한 내용을 스터디 1시간 전에 블로그 글 공유하기.
5. 면접관의 입장이 되어서 질문해보기. 
6. 면접자 본인스스로 생각하기에 깔끔하고 정리되어있는 답변하기.  
